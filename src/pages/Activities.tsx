...
const activities: Activity[] = [
  ...
  },
  {
    ...
    description: "Rejuvenate with luxury spa treatments featuring highland tranquility, holistic therapies, and couples packages in the serene Dullstroom atmosphere.",
    icon: TreePine,
    duration: "2-4 Hours",
    season: "Year Round",
    difficulty: "Pure Relaxation",
    highlights: ["Highland Views", "Holistic Treatments", "Couples Packages", "Highland Tranquility"],
  ...
  },
  {
    ...
    highlights: ["Highland Views", "Wildlife Spotting", "Photography", "Highland Flora"],
  ...
  },
  {
    ...
    highlights: ["Championship Courses", "Highland Views", "Clubhouse Dining", "Golf Pro Services"],
