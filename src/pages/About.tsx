...
export default function About() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative py-24 bg-gradient-to-br from-accent to-muted">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-primary mb-6">About The Browns</h1>
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-6">
                    <h3 className="text-primary mb-4">Luxury Guest Suites</h3>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-center">
                        ...
                        4 ensuite bedrooms with elegant appointments
                      </li>
                      <li className="flex items-center">
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-6">
                    <h3 className="text-primary mb-4">Cottage Suites</h3>
                    <p className="text-muted-foreground mb-4">
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-center">
                        <MapPin className="h-4 w-4 mr-2 text-primary" />
                        3 available cottage suites with fireplaces
                      </li>
                      <li className="flex items-center">
                        <Users className="h-4 w-4 mr-2 text-primary" />
                        Up to 6 adults + 1 child accommodation
                      </li>
                      <li className="flex items-center">
                        <Calendar className="h-4 w-4 mr-2 text-primary" />
                        Cozy comfort with vintage charm elements
                      </li>
                    </ul>
                  </CardContent>
                </Card>
