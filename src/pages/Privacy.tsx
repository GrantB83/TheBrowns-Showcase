              ...
              <CardContent className="p-6 sm:p-8 space-y-6 sm:space-y-8">
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="font-semibold mb-2 text-fluid-base">Personal Information</h3>
                      <p className="text-fluid-base text-muted-foreground leading-relaxed">
                      ...
                      <ul className="list-disc list-inside mt-2 text-fluid-sm text-muted-foreground space-y-1">
                    ...
                    <div>
                      <h3 className="font-semibold mb-2 text-fluid-base">Automatically Collected Information</h3>
                      <p className="text-fluid-base text-muted-foreground leading-relaxed">
                ...
                <section>
                  ...
                  <p className="text-fluid-base text-muted-foreground leading-relaxed mb-4">
                    We use the information we collect for various purposes, including:
                  </p>
                  <ul className="list-disc list-inside text-fluid-sm text-muted-foreground space-y-1">
