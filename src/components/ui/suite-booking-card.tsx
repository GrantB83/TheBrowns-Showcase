    ...
    <Card className={cn("overflow-hidden hover:shadow-xl transition-shadow duration-300", className)}>
      ...
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="overview" className="space-y-6 mt-0 pt-6 sm:pt-0">
          ...
          <TabsContent value="amenities" className="space-y-6 mt-0 pt-6 sm:pt-0">
          ...
          <TabsContent value="gallery" className="space-y-6 mt-0 pt-6 sm:pt-0">
            {isLoadingImages ? (
          ...
          <TabsContent value="reviews" className="space-y-6 mt-0 pt-6 sm:pt-0">
